...
def download_files_from_list(file_list, local_path, username, password, threads):
    ...
    try:
        ...
        subprocess.run(["rclone", "copy", ":http:", local_path,
...
def main():
    ...
    if masked == "all":
        ...
        for batch in file_batches:
            download_files_from_list(batch, target_dir, username, password, threads)
