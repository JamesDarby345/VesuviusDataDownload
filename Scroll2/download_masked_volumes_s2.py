...
def main():
    ...
    base_url = "/full-scrolls/Scroll2.volpkg/volumes_masked/20230210143520/"
    target_dir = "./masked_volumes/20230210143520/"
    ...
    if range_input == "all":
        ...
        for start, end in ranges:
            ...
            if start > scrollZAxis or end > scrollZAxis or start < 0 or end < 0:
                ...
                print(f"Please use valid scroll 2 .tif volume numbers (0-{scrollZAxis})")
